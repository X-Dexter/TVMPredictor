...
create_dataset_nd(function={"body":calculate_time,"params":{"target": "llvm", "device": tvm.cpu(0)}},shape_relation={lambda x:x}, max_shapes=(100,100,100),sampling=(0.15,0.15,0.15),dtype="float32",file_name="batch_normal_float.txt")